...
import 'package:fakelab_records_webapp/core/constants/env.dart' as _i584;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    await gh.factoryAsync<_i584.Env>(
      () => _i584.Env.load(),
      preResolve: true,
    );
    gh.singleton<_i352.AppRouter>(() => _i352.AppRouter());
    gh.factory<_i29.AudioPlayerBloc>(() => _i29.AudioPlayerBloc(
          gh<_i584.Env>(),
          gh<_i842.AssetsAudioPlayer>(),
        ));
