...
import 'package:fakelab_records_webapp/presentation/screens/admin/features/clients/features/create_client/presentation/admin_create_client_screen.dart'
    as _i1;
import 'package:fakelab_records_webapp/presentation/screens/admin/features/clients/features/edit_client/presentation/admin_edit_staff_member_screen.dart'
    as _i3;
...
class AdminCreateClientRoute
    extends _i13.PageRouteInfo<AdminCreateClientRouteArgs> {
  AdminCreateClientRoute({
    required _i14.AdminClientsBloc adminClientsBloc,
    _i15.Key? key,
...
class AdminCreateClientRouteArgs {
  ...
  final _i14.AdminClientsBloc adminClientsBloc;
...
class AdminCreateStaffMemberRoute
    extends _i13.PageRouteInfo<AdminCreateStaffMemberRouteArgs> {
  AdminCreateStaffMemberRoute({
    required _i16.AdminStaffBloc adminStaffBloc,
    _i15.Key? key,
    List<_i13.PageRouteInfo>? children,
  }) : super(
...
class AdminCreateStaffMemberRouteArgs {
  ...
  final _i16.AdminStaffBloc adminStaffBloc;
...
/// generated route for
/// [_i3.AdminEditStaffMemberScreen]
class AdminEditStaffMemberRoute
    extends _i13.PageRouteInfo<AdminEditStaffMemberRouteArgs> {
  AdminEditStaffMemberRoute({
    required String id,
    required _i17.StaffMember staffMember,
    required _i16.AdminStaffBloc adminStaffBloc,
    _i15.Key? key,
    List<_i13.PageRouteInfo>? children,
  }) : super(
  ...
  static _i13.PageInfo page = _i13.PageInfo(
    ...
    builder: (data) {
      ...
      return _i3.AdminEditStaffMemberScreen(
        id: args.id,
...
class AdminEditStaffMemberRouteArgs {
  ...
  final _i17.StaffMember staffMember;
...
/// generated route for
/// [_i4.AdminOrderScreen]
class AdminOrderRoute extends _i13.PageRouteInfo<AdminOrderRouteArgs> {
  AdminOrderRoute({
...
/// generated route for
/// [_i8.ImagesViewerScreen]
class ImagesViewerRoute extends _i13.PageRouteInfo<ImagesViewerRouteArgs> {
  ImagesViewerRoute({
    required List<String> images,
    required int initialIndex,
    _i8.ImageSource source = _i8.ImageSource.network,
    _i15.Key? key,
    List<_i13.PageRouteInfo>? children,
  }) : super(
...
class ImagesViewerRouteArgs {
  const ImagesViewerRouteArgs({
    ...
    this.source = _i8.ImageSource.network,
    this.key,
  });
...
/// generated route for
/// [_i9.LoyaltyScreen]
class LoyaltyRoute extends _i13.PageRouteInfo<void> {
  const LoyaltyRoute({List<_i13.PageRouteInfo>? children})
  ...
  static _i13.PageInfo page = _i13.PageInfo(
    name,
    builder: (data) {
      return const _i9.LoyaltyScreen();
    },
  );
}
...
/// generated route for
/// [_i10.MyOrderScreen]
class MyOrderRoute extends _i13.PageRouteInfo<MyOrderRouteArgs> {
  MyOrderRoute({
    required String orderId,
    _i15.Key? key,
    List<_i13.PageRouteInfo>? children,
  ...
  static _i13.PageInfo page = _i13.PageInfo(
    ...
    builder: (data) {
      ...
      return _i10.MyOrderScreen(orderId: args.orderId, key: args.key);
    },
  );
}
...
/// generated route for
/// [_i12.UnsupportedScreen]
class UnsupportedRoute extends _i13.PageRouteInfo<void> {
  const UnsupportedRoute({List<_i13.PageRouteInfo>? children})
  ...
  static _i13.PageInfo page = _i13.PageInfo(
    name,
    builder: (data) {
      return const _i12.UnsupportedScreen();
    },
  );
}
